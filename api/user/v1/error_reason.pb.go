...
const file_user_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1auser/v1/error_reason.proto\x12\auser.v1*x\n" +
	"\vErrorReason\x12\x14\n" +
	"\x10USER_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x01\x12\x13\n" +
	"\x0fUSERNAME_EXISTS\x10\x02\x12\x17\n" +
	"\x13INVALID_CREDENTIALS\x10\x03\x12\x11\n" +
	"\rINVALID_TOKEN\x10\x04B<Z:github.com/go-kratos/kratos-layout-monolith/api/user/v1;v1b\x06proto3"
